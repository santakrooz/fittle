# 0003 — Free web edition with opt-in header contributions

Date: 2026-09-25 · Status: accepted, scheduled after M1
...
- **Hosting: Railway.** One small Rust (axum) service serves the prerendered
